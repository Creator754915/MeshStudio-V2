...
if __name__ == "__main__":
    from MeshStudio.MeshStudio import CurrentFolderNameReturner

    ProjectExporter("w", f"{CurrentFolderNameReturner()}/Current Games",
                    ToSavePath=CurrentFolderNameReturner().replace("Editor", "FInal"))
