...
class BlueLink(Button):
    ...
    def __init__(self, text='...', radius=0.1, ToSubtract=0, Key=None, partKey="", on_key_press=None, on_hover=None,
        ...
        super().__init__(text, radius, ToSubtract=ToSubtract, Key=Key, partKey=partKey, on_key_press=on_key_press,
                         on_hover=on_hover, on_unhover=on_unhover, hover_highlight=hover_highlight,
                         hover_highlight_color=hover_highlight_color, hover_highlight_size=hover_highlight_size,
                         hover_highlight_button=hover_highlight_button, **kwargs)

        self.MouseCursor: Cursor = Cursor(model="cube", texture="../../icons/BlueLinkMouse.png", scale=.033, enabled=False,
