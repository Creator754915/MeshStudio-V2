...
from MeshStudio.MainFiles.Gizmo.ScaleGizmo import ScaleGizmo


class AddEntity(Entity):
    def __init__(self, parent=scene, model="cube", name="Entity1", color=color.white, scale=1,
        ...
        self.positionGizmo.scale = self.scale
        self.scaleGizmo.scale = self.scale
